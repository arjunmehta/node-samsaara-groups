...
Group.prototype.nameSpace = function(namespaceName) {
    ...
    return {
        execute: function(funcName) {
            executionController.execute(createSendClosure(memberList), 'GRP', memberList, namespaceName, funcName, arguments);
        }
    };
};
...
Group.prototype.execute = function(funcName) {
    var memberList = Object.keys(this.members);
    executionController.execute(createSendClosure(memberList), 'GRP', memberList, 'core', funcName, arguments);
};
